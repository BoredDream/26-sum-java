...
export const menus: MenuItem[] = [
  ...
  { title: '题目浏览', path: '/topic/browse', icon: 'Reading', roles: ['STUDENT', 'TEACHER', 'ADMIN'] },
  ...
  { title: '我的选题申请', path: '/selection/my-application', icon: 'DocumentChecked', roles: ['STUDENT'] },
  { title: '选题审核', path: '/selection/applications/pending', icon: 'Stamp', roles: ['TEACHER'] },
  { title: '我的过程文档', path: '/selection/documents/my', icon: 'FolderOpened', roles: ['STUDENT'] },
  ...
  { title: '考勤统计', path: '/attendance/statistics', icon: 'TrendCharts', roles: ['TEACHER', 'ADMIN'] },
